...
import { useCms, AUTHORIZED_ADMIN_EMAIL, ADMIN_USERNAME } from '../context/CmsContext';
...
export const AdminDashboard: React.FC = () => {
  ...
  // Login form state (Strict credentials: username: rnfadminhebat, password: rnfnumber1)
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!result.success) {
        setAuthError(result.error || 'Akses ditolak: Nama pengguna atau kata laluan tidak sah.');
      }
    } catch {
      setAuthError('Ralat sambungan ke pelayan pentadbir.');
    } finally {
  ...
  // =========================================================================
  // VIEW A: AUTHENTICATION LOCK SCREEN (Accessible only through /admin)
  // =========================================================================
  if (!isAdminLoggedIn) {
    return (
        ...
        <div className="max-w-md w-full relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="font-['Outfit'] text-2xl sm:text-3xl font-black text-white tracking-tight">
              Portal Pentadbir Backend
            </h1>
            <p className="text-xs sm:text-sm text-slate-400 mt-1">
              RNF Business Solutions • Sistem Pengurusan & Kawalan Bersepadu
            </p>

            <div className="mt-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-800/90 border border-slate-700 text-emerald-400 text-xs font-semibold">
              <Shield className="w-3.5 h-3.5 text-emerald-400" />
              <span>Akses Khas: <strong>/admin</strong></span>
            </div>
          </div>
          ...
          <div className="bg-slate-800/90 border border-slate-700 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Masukkan username pentadbir"
                    autoComplete="username"
                    autoFocus
                    required
                    className="w-full pl-9 pr-3 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-9 pr-10 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs sm:text-sm rounded-xl shadow-lg transition-all cursor-pointer flex items-center justify-center gap-2 mt-2"
              >
                <Unlock className="w-4 h-4" />
                <span>{isSubmitting ? 'Mengesahkan...' : 'Log Masuk ke Backend'}</span>
              </button>
            </form>
            ...
            <div className="mt-5 pt-4 border-t border-slate-700/80">
              <button
                ...
                className="w-full py-2 text-slate-400 hover:text-slate-200 text-xs font-semibold transition-colors cursor-pointer text-center"
              >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-300 flex items-center gap-1.5">
                <span>Pentadbir:</span>
                <strong className="text-emerald-400">{currentAdminEmail || ADMIN_USERNAME}</strong>
              </div>
            </div>
          </div>
